...
struct SequenceExposureStatistics_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::image_exposure_msgs::ImageExposureStatistics_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::image_exposure_msgs::ImageExposureStatistics_<ContainerAllocator> >> _exposures_type;
...
bool operator==(const ::image_exposure_msgs::SequenceExposureStatistics_<ContainerAllocator1> & lhs, const ::image_exposure_msgs::SequenceExposureStatistics_<ContainerAllocator2> & rhs)
{
  return lhs.exposures == rhs.exposures &&
