...
struct ExposureSequence_
{
  ...
  _header_type header;
   ...
   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _shutter_type;
...
bool operator==(const ::image_exposure_msgs::ExposureSequence_<ContainerAllocator1> & lhs, const ::image_exposure_msgs::ExposureSequence_<ContainerAllocator2> & rhs)
{
