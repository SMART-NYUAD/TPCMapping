...
struct ImageExposureStatistics_
{
  ...
  _stamp_type stamp;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _time_reference_type;
...
bool operator==(const ::image_exposure_msgs::ImageExposureStatistics_<ContainerAllocator1> & lhs, const ::image_exposure_msgs::ImageExposureStatistics_<ContainerAllocator2> & rhs)
{
  return lhs.stamp == rhs.stamp &&
    lhs.time_reference == rhs.time_reference &&
    lhs.shutterms == rhs.shutterms &&
    lhs.gaindb == rhs.gaindb &&
    lhs.underExposed == rhs.underExposed &&
    lhs.overExposed == rhs.overExposed &&
    lhs.pixelVal == rhs.pixelVal &&
    lhs.pixelAge == rhs.pixelAge &&
    lhs.meanIrradiance == rhs.meanIrradiance &&
    lhs.minMeasurableIrradiance == rhs.minMeasurableIrradiance &&
    lhs.maxMeasurableIrradiance == rhs.maxMeasurableIrradiance &&
    lhs.minObservedIrradiance == rhs.minObservedIrradiance &&
    lhs.maxObservedIrradiance == rhs.maxObservedIrradiance;
}
...
struct Printer< ::image_exposure_msgs::ImageExposureStatistics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::image_exposure_msgs::ImageExposureStatistics_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.time_reference);
    s << indent << "shutterms: ";
