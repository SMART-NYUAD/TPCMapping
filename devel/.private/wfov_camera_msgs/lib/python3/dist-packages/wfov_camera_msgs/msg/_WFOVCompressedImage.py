...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.time_reference = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.worldToCamera.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.worldToCamera.child_frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
