...
bool operator==(const ::wfov_camera_msgs::WFOVCompressedImage_<ContainerAllocator1> & lhs, const ::wfov_camera_msgs::WFOVCompressedImage_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.gain == rhs.gain &&
    lhs.white_balance_blue == rhs.white_balance_blue &&
    lhs.white_balance_red == rhs.white_balance_red &&
    lhs.temperature == rhs.temperature &&
    lhs.worldToCamera == rhs.worldToCamera;
}
