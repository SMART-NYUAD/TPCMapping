...
struct WFOVTrigger_
{
  ...
  _trigger_time_type trigger_time;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _trigger_time_reference_type;
...
bool operator==(const ::wfov_camera_msgs::WFOVTrigger_<ContainerAllocator1> & lhs, const ::wfov_camera_msgs::WFOVTrigger_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.time_reference == rhs.time_reference &&
    lhs.trigger_time == rhs.trigger_time &&
    lhs.trigger_time_reference == rhs.trigger_time_reference &&
    lhs.shutter == rhs.shutter &&
    lhs.id == rhs.id &&
    lhs.trigger_seq == rhs.trigger_seq;
}
...
struct Printer< ::wfov_camera_msgs::WFOVTrigger_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::wfov_camera_msgs::WFOVTrigger_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.trigger_time_reference);
    s << indent << "shutter: ";
