...
class pan_tiltRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type pan_tiltRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type pan_tiltRequest
    let len;
    let data = new pan_tiltRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new pan_tiltRequest(null);
...
class pan_tiltResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type pan_tiltResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type pan_tiltResponse
    let len;
    let data = new pan_tiltResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new pan_tiltResponse(null);
...
module.exports = {
  Request: pan_tiltRequest,
  Response: pan_tiltResponse,
  md5sum() { return '2e2b5f145e29f6b78ab4fe0698b7903a'; },
  datatype() { return 'ptu_control/pan_tilt'; }
};
